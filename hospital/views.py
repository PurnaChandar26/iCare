...
def download_pdf_view(request,pk):
    ...
    dict={
        'Name of the Patient':dischargeDetails[0].patientName,
        'Name of Doctor':dischargeDetails[0].assignedDoctorName,
        'Address':dischargeDetails[0].address,
        'Mobile':dischargeDetails[0].mobile,
        'Symptoms':dischargeDetails[0].symptoms,
        'Admit Date':dischargeDetails[0].admitDate,
        'Discharge Date':dischargeDetails[0].releaseDate,
        'No. of Days':dischargeDetails[0].daySpent,
        'Price of Medicines':dischargeDetails[0].medicineCost,
        'Room Charge':dischargeDetails[0].roomCharge,
        'Doctor Fees':dischargeDetails[0].doctorFee,
        'Other Charges':dischargeDetails[0].OtherCharge,
        'Total amount payable':dischargeDetails[0].total,
    }
